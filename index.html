...
<html lang="en">
	...
	<body onload="init()">
		...
		<div class="container">
			...
			<div class="pengembang">AgusFirman7</div>
		</div>
		...
		<script type="text/javascript">
			...
			function startTime() {
				...
				if (H<5){
					...
					txt='Good Afternoon Honey :)';
					if(txt != txt2 && !starting)
						document.getElementById("quote").innerHTML = txt;
					txt2=txt;
				}
				else if(H<19){
					txt='Good Afternoon Beb, Take a Rest :)';
					if(txt != txt2 && !starting)
						document.getElementById("quote").innerHTML = txt;
					txt2=txt;
				}
			...
			const quotes = [
			  ...
			  {
			    "quote": "Selamat Beraktivitas Sayangku :* ",
			    "source": "Agus Firmansyah"
			  },
			  {
			    "quote": "I Miss Someone",
			    "source": "Agus Firmansyah"
			  },
			  {
			  ...
			  {
			    "quote": "I Love You 4 Ever 'Someone' ",
			    "source": "Agus Firmansyah"
			  },
			  {
			    "quote": "Heii, Do You Love Me?",
			    "source": "Agus Firmansyah"
			  },
			  {
